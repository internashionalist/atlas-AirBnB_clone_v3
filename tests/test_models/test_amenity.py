...
class TestAmenityDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_amenity(self):
        """
        tests amenity.py conformity to PEP8
        """
    ...
    def test_pep8_conformance_test_amenity(self):
        """
        tests test_amenity.py conformity to PEP8
        """
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_amenity_module_docstring(self):
        """
        tests for the existence of docstring in amenity module
        """
    ...
    def test_amenity_class_docstring(self):
        """
        tests for the presence of a docstring in Amenity class
        """
        self.assertIsNot(Amenity.__doc__, None,
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """
        tests if Amenity has attribute 'name'
        """
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """
        tests if 'to_dict' creates a dictionary
        """
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """
        tests if 'to_dict' values are correct
        """
