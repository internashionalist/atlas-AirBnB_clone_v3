...
class TestPlaceDocs(unittest.TestCase):
    """
    tests the documentation and style of Place class
    """
    @classmethod
    def setUpClass(cls):
        """
    ...
    def test_pep8_conformance_place(self):
        """
        tests place.py conformity to PEP8
        """
    ...
    def test_pep8_conformance_test_place(self):
        """
        tests test_place.py conformity to PEP8
        """
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_place_module_docstring(self):
        """
        tests for the existence of a module docstring
        """
...
class TestPlace(unittest.TestCase):
    """
    tests the functionality of Place class
    """
    ...
    def test_city_id_attr(self):
        """
        tests that Place has attr 'city_id', and it's an empty string
        """
        place = Place()
    ...
    def test_user_id_attr(self):
        """
        tests that Place has attr 'user_id', and it's an empty string
        """
        place = Place()
    ...
    def test_name_attr(self):
        """
        tests that Place has attr 'name', and it's an empty string
        """
        place = Place()
    ...
    def test_description_attr(self):
        """
        tests that Place has attr 'description', and it's an empty string
        """
        place = Place()
    ...
    def test_number_rooms_attr(self):
        """
        tests that Place has attr 'number_rooms', and it's an int == 0
        """
        place = Place()
    ...
    def test_number_bathrooms_attr(self):
        """
        tests that Place has attr 'number_bathrooms', and it's an int == 0
        """
        place = Place()
    ...
    def test_max_guest_attr(self):
        """
        tests that Place has attr 'max_guest', and it's an int == 0
        """
        place = Place()
    ...
    def test_price_by_night_attr(self):
        """
        tests that Place has attr 'price_by_night', and it's an int == 0
        """
        place = Place()
    ...
    def test_latitude_attr(self):
        """
        tests that Place has attr 'latitude', and it's a float == 0.0
        """
        place = Place()
    ...
    def test_longitude_attr(self):
        """
        tests that Place has attr 'longitude', and it's a float == 0.0
        """
        place = Place()
    ...
    def test_amenity_ids_attr(self):
        """
        tests that Place has attr 'amenity_ids', and it's an empty list
        """
        place = Place()
    ...
    def test_to_dict_creates_dict(self):
        """
        tests that 'to_dict' creates a dictionary
        """
        p = Place()
        new_d = p.to_dict()
    ...
    def test_to_dict_values(self):
        """
        tests that the values in the dictionary are correct
        """
