...
class TestReviewDocs(unittest.TestCase):
    """
    tests the documentation and style of Review class
    """
    @classmethod
    def setUpClass(cls):
        """
    ...
    def test_pep8_conformance_review(self):
        """
        tests review.py conformity to PEP8
        """
    ...
    def test_pep8_conformance_test_review(self):
        """
        tests test_review.py conformity to PEP8
        """
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_review_func_docstrings(self):
        """
        tests for the presence of a docstring in all functions
        """
...
class TestReview(unittest.TestCase):
    """
    tests the functionality of Review class
    """
    ...
    def test_place_id_attr(self):
        """
        tests that Review has attr 'place_id' and it's an empty string
        """
        review = Review()
    ...
    def test_user_id_attr(self):
        """
        tests that Review has attr 'user_id' and it's an empty string
        """
        review = Review()
    ...
    def test_text_attr(self):
        """
        tests that Review has attr 'text' and it's an empty string
        """
        review = Review()
